...
conditionSnapshotSchema.statics.create = (condition: Condition) => {
...
var ConditionSnapshot = <{ new (Condition): ConditionSnapshot }>mongoose.model('ConditionSnapshot', conditionSnapshotSchema);
